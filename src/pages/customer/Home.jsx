...
const Home = () => {
  ...
  return (
    <div className="animate-fade-in">
      {/* 1. HERO SECTION */}
      <section className="relative overflow-hidden bg-gradient-to-br from-astraea-white to-astraea-blush min-h-[85vh] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 z-10 space-y-6 text-center md:text-left pt-12 md:pt-0">
            <h1 className="font-heading text-5xl md:text-7xl font-bold text-astraea-pink leading-tight">
              Astraea Collection
            </h1>
            <p className="text-xl md:text-2xl text-astraea-darkgray font-light max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-4 justify-center md:justify-start">
              <Link to="/shop" className="px-8 py-3 bg-astraea-pink text-white rounded-full font-medium hover:bg-astraea-pink/90 transition-colors shadow-sm text-center">
                Shop Bouquets
              </Link>
              <Link to="/customize" className="px-8 py-3 bg-transparent border-2 border-astraea-pink text-astraea-pink rounded-full font-medium hover:bg-astraea-pink/5 transition-colors text-center">
                Customize Yours
              </Link>
            </div>
          </div>
          <div className="md:w-1/2 mt-12 md:mt-0 relative flex justify-center">
            ...
            <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full bg-astraea-pink/10 flex items-center justify-center overflow-hidden border border-astraea-rosegold/20">
      ...
      <section className="py-20 bg-astraea-blush/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 text-center md:text-left space-y-6">
              <h2 className="font-heading text-4xl font-bold text-astraea-darkgray">Flowers That Never Wilt</h2>
              <p className="text-lg leading-relaxed text-astraea-darkgray/80">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-heading text-4xl font-bold text-astraea-darkgray">Our Bestsellers</h2>
              ...
              {featuredBouquets.map((bouquet) => (
                <div key={bouquet.id} className="group bg-white rounded-xl border border-astraea-pink/30 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="p-6 space-y-4">
                    <h3 className="font-heading font-bold text-xl text-astraea-darkgray line-clamp-1">{bouquet.name}</h3>
                    <p className="font-bold text-astraea-pink">₱{bouquet.price}</p>
                    <Link to={`/shop/${bouquet.id}`} className="block w-full py-2 text-center border border-astraea-pink text-astraea-pink rounded-full hover:bg-astraea-pink hover:text-white transition-colors">
                      View
                    </Link>
                  </div>
                </div>
      ...
      {/* 4. HOW IT WORKS */}
      <section className="py-20 bg-astraea-blush">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-heading text-4xl font-bold text-astraea-darkgray">How It Works</h2>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-heading text-4xl font-bold text-astraea-darkgray">What Our Customers Say</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {reviews.map((review) => (
              <div key={review.id} className="bg-astraea-blush/50 p-8 rounded-2xl border border-astraea-rosegold/20">
      ...
      <section className="bg-astraea-pink py-16 text-center">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          <h2 className="font-heading text-4xl md:text-5xl font-bold text-white">Ready to build your dream bouquet?</h2>
          <Link to="/customize" className="inline-block px-10 py-4 bg-white text-astraea-pink rounded-full font-bold text-lg hover:bg-astraea-blush transition-colors shadow-lg">
            Start Customizing
          </Link>
        </div>
      </section>
