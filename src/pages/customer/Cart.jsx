                ...
                <div className="flex-grow flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-end mt-4 sm:mt-0">
                    <div className="flex items-center border-2 border-dashed border-astraea-pink/40 rounded-full bg-white shadow-[3px_3px_0px_#F9A8C9]">
                      <button onClick={() => updateQuantity(item.cartId, item.quantity - 1)} className="min-h-11 min-w-11 flex items-center justify-center text-astraea-darkgray hover:text-astraea-pink"><Minus className="w-4 h-4" /></button>
                      <span className="w-10 text-center font-bold text-sm">{item.quantity}</span>
                      <button onClick={() => updateQuantity(item.cartId, item.quantity + 1)} className="min-h-11 min-w-11 flex items-center justify-center text-astraea-darkgray hover:text-astraea-pink"><Plus className="w-4 h-4" /></button>
                    </div>
