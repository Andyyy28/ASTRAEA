    ...
    <div className="py-8 md:py-16 bg-astraea-cream min-h-screen animate-fade-in">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="font-accent text-2xl text-astraea-rosegold">We'd love to hear from you. Send us a message or reach out on WhatsApp.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-0 bg-[#FFFDFE] rounded-3xl shadow-[4px_4px_0px_#F9A8C9] border-2 border-dashed border-astraea-pink overflow-hidden">
          <div className="lg:w-1/2 p-4 md:p-12 order-2 lg:order-1">
            <h2 className="section-heading text-xl md:text-3xl mb-8">✿ Send a Message</h2>
            {submitted ? (
          ...
          <div className="lg:w-1/2 p-4 md:p-12 bg-astraea-blush/30 lg:border-l-2 lg:border-dashed border-astraea-pink order-1 lg:order-2">
            <h2 className="section-heading text-xl md:text-3xl mb-8">★ Contact Information</h2>
            <div className="space-y-8">
              <div className="scrapbook-card bg-white/90 text-center">
                ...
                <a href="https://wa.me/639123456789" target="_blank" rel="noreferrer" className="kawaii-btn-primary w-full justify-center mt-2">Chat with us on WhatsApp</a>
              </div>
              <ul className="space-y-6">
                <li className="flex items-start"><Mail className="w-6 h-6 text-astraea-pink mr-4 shrink-0" /><div><h4 className="font-bold">Email Address</h4><p className="text-astraea-darkgray/70">hello@astraeacollection.com</p></div></li>
              ...
              <div className="pt-6 border-t-2 border-dashed border-astraea-pink/30">
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-12 h-12 bg-white rounded-full flex items-center justify-center border-2 border-dashed border-astraea-pink/40 hover:text-astraea-pink transition-colors shadow-[3px_3px_0px_#F9A8C9]"><Globe className="w-6 h-6" /></a>
                  <a href="#" className="w-12 h-12 bg-white rounded-full flex items-center justify-center border-2 border-dashed border-astraea-pink/40 hover:text-astraea-pink transition-colors shadow-[3px_3px_0px_#F9A8C9]"><AtSign className="w-6 h-6" /></a>
                </div>
              </div>
            </div>
          </div>
